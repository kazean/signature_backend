...
> - Spring Filter, API Specification, ExceptionHandler, Interceptor
> - Jwt, WebMvcConfigurer, HandlerInterceptor, HandlerMethodArgsResolver
> - Project: 가맹점 서버 개발 with SpringSecurity
...
> - Spring 과 Kotlin
> - MSA, Monotoring(ELK, Spring Boot Admin, Prometheus/Grafana, TICK)
> - Redis 기초
