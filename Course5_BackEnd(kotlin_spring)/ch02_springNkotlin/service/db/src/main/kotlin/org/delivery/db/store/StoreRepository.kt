...
interface StoreRepository : JpaRepository<StoreEntity?, Long?> {
    ...
    fun findFirstByIdAndStatusOrderByIdDesc(id: Long?, status: StoreStatus?): Optional<StoreEntity?>?
    ...
    fun findFirstByNameAndStatusOrderByIdDesc(name: String?, status: StoreStatus?): Optional<StoreEntity?>?
}