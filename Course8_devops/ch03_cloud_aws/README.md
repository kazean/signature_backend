...
- [16. Amazon Route53으로 도메인 서비스 구축하기(실습)](#ch03-16-amazon-route53으로-도메인-서비스-구축하기실습)
...
> > 사용자에게 콘솔 액세스 권한을 제공/IAM 사용자를 생성하고 싶음
- MFA 인증 추가
...
---------------------------------------------------------------------------------------------------------------------------
# Ch03-08. Amazon EC2 인스턴스 만들기(실습) - IAM User
