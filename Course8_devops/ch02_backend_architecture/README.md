...
- [2. MSA 아키텍쳐 기반의 서비스 이해](#ch02-02-msa-아키텍쳐-기반의-서비스-이해)
- [3. 멀티모듈로 구성하는 코드 - Java 기반](#ch02-03-멀티모듈로-구성하는-코드---java-기반)
- [4. LAB Code로 다루는 DDD - MSA - multi module 사례보기](#ch02-04-lab-code로-다루는-ddd---msa---multi-module-사례보기)
